        ...
        <div className="login-form">
            ...
            <div className="group">
              ...
              <div className='user-rol'>
                <label htmlFor="check-client">
                  <input id='check-client' type="radio" name='singin-rol' checked /> CLIENT
                </label>
                <label htmlFor="check-driver">
                  <input id='check-driver' type="radio" name='singin-rol' /> DRIVER
                </label>
              </div>
            </div>
            <div className="group">
          ...
          <div className="sign-up-htm">
            ...
            <div className="group">
              ...
              <div className='user-rol'>
                <label htmlFor="check-client">
                  <input id='check-client' type="radio" name='user-rol' checked /> CLIENT
                </label>
                <label htmlFor="check-driver">
